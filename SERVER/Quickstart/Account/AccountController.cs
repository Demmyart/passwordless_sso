...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            if (button != "login")
            {
                ...
                if (context != null)
                {
                    ...
                    // denied the consent (even if this client does not require c Console.WriteLine(model.ReturnUrl);onsent).
...

            {
                ...
                else
                {
                    ...
                    var url = Url.Action("LoginCallback", "Account", new { token = token, email=user}, Request.Scheme);
                    System.IO.File.WriteAllText("passwordless.txt", url);
                    Response.Cookies.Append("href", model.ReturnUrl);
                }
        ...
        {
            string url = Request.Cookies["href"];
                ...
                //await _userManager.UpdateSecurityStampAsync(user);
                    ...
                    //await HttpContext.SignInAsync(
                        ...
                        //new ClaimsPrincipal(new ClaimsIdentity(
                            //new List<Claim> { new Claim("sub", user.Email) },
                            //IdentityConstants.ApplicationScheme)));
                    //return RedirectToAction("Index", "Home");
                return Redirect(url);
